 ...
 *
 */
public class EquivalencePartition implements TestTechnique {
	
	public EquivalencePartition() {
		super();
		// TODO Auto-generated constructor stub
	}

	@Override
	public List<TestData> use(List<TestData> testDataList) throws Exception {
